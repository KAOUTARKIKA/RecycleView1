    ...
    public StarViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                alertDialogBuilder.setMessage("Voulez-vous supprimer cette star ?");
                ...
                alertDialogBuilder.setPositiveButton("Supprimer", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (position != RecyclerView.NO_POSITION) {
                            Star starToRemove = starsFilter.get(position);
                            stars.remove(starToRemove); // Remove from original list
                            starsFilter.remove(position); // Remove from filtered list
